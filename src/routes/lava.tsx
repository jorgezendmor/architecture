...
import p09L from "@/assets/portfolio/page-09-new-left.svg";
import p09R from "@/assets/portfolio/page-09-new-right.svg";
import p10 from "@/assets/portfolio/page-10-v7.svg";
...
export const Route = createFileRoute("/lava")({
  ...
  component: () => (
    <ProjectPage
      ...
      prev={{ to: "/chichu", label: "01" }}
      next={{ to: "/retreat", label: "03" }}
    />
  ),
});
